...
\definecolor{primaryColor}{RGB}{31, 69, 41} % define primary color
...
\begin{document}
    ...
    \begin{header}
        ...
        \normalsize
        \mbox{{\footnotesize\faMapMarker*}\hspace*{0.13cm}Rennes, France}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{mailto:hugues.connan@gmail.com}{{\footnotesize\faEnvelope[regular]}\hspace*{0.13cm}hugues.connan@gmail.com}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{tel:+33 6 67 01 92 19}{{\footnotesize\faPhone*}\hspace*{0.13cm}+33 6 67 01 92 19}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        ...
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{https://linkedin.com/in/hugues-connan}{{\footnotesize\faLinkedinIn}\hspace*{0.13cm}/hugues-connan}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{https://github.com/}{{\footnotesize\faGithub}\hspace*{0.13cm}yourusername}}%
    \end{header}
