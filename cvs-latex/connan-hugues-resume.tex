...
\begin{justify}
  Contributed to 2 significants inner-source projects built an online and offline Platform-as-a-Service atop respectively \textbf{Kubernetes} and \textbf{OpenShift}, production-ready, latency-critical and high-available.
\end{justify}
\vspace{-2mm}
