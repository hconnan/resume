...
\newcommand{\midrule}[1]{
  \leavevmode
  \xrfill[.5ex]{1pt}[accent]~\color{accent}\so{#1}~\xrfill[.5ex]{1pt}[accent]
}
...
\titleformat*{\subsection}{\large\bfseries\scshape\color{accent}}
\titleformat*{\subsubsection}{\bfseries\scshape\color{accent}}
...
\subsection{Cloud DevOps Engineer \rside{Sept 2019 -- Feb 2022}}
\subsubsection{Thales \rside{Rennes, France}}

\begin{justify}
  I contributed to 2 significant inner-source projects built an online and offline Platform-as-a-Service atop \textbf{Kubernetes} and \textbf{OpenShift}, production-ready, latency-critical and high-availabile.
\end{justify}
\vspace{-2mm}
...
%===============
\begin{description}
  \item[Cloud \& On-Premise] Google Cloud, Amazon Web Services, Kubernetes
...
\begin{enumerate}[label=\null, left=0pt..0pt, itemsep=0pt]
  ...
  \item \href{https://www.credly.com/badges/c0ff3fcc-9513-4fab-ac8a-95061a53f343/public_url}{Certified Kubernetes Administrators} \rside{2022}
\end{enumerate}
