...
\begin{justify}
  Contributed to 2 significants inner-source projects built an online and offline Platform-as-a-Service atop respectively \textbf{Kubernetes} and \textbf{OpenShift}, production-ready, latency-critical and high-availabile.
\end{justify}
\vspace{-2mm}
...
\begin{itemize}
  \item "Grande Ecole" academic excellence program graduated with a Master's degree in \textbf{Information Systems Engineering}
\end{itemize}
...
\begin{itemize}
  \item Sucessfully followed the Computer Science BSc, stage 3 for one semester as an \textbf{Erasmus student}.
\end{itemize}

\section{Skills}
%===============
\begin{description}
  \item[Cloud \& On-Premise] Kubernetes, Google Cloud, Amazon Web Services
  \item[DevOps] Terraform, Ansible, GitLab CI, Kubernetes, Docker, Helm, Kustomize, ArgoCD, Go, Python
